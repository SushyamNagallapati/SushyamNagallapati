...
A modular multi-agent AI system that resolves health insurance claim queries using RAG pipelines, NL-to-SQL generation, and automated email workflows. Achieved ~88% answer correctness and 100% SQL accuracy on small schemas with ~2s end-to-end latency.
...
React frontend with real-time movie search, favorites management, and reusable component architecture using modern React hooks (useState, useEffect) for clean state management.
